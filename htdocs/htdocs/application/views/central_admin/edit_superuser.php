...
<!--main content top-->
  ...
  <hr>
    ...
    <br>
    <ul>
        <li class="field"><input class="text input" type="text" placeholder="First Name" name="first_name" id="first_name" value="<?php echo @$admin_user['first_name'][0];  ?>" /></li>
        <li class="field"><input class="text input" type="text" placeholder="Last Name" name="last_name" id="first_name" value="<?php echo @$admin_user['last_name'][0];  ?>" /></li>
        <li class="field"><input class="text input" type="text" placeholder="User Email" name="email" id="email" value="<?php echo @$admin_user['email'][0];  ?>" /></li>
        ...
        <li class="field"><input class="password input" type="password" placeholder="User Password" name="usr_pwd" id="usr_pwd" value="<?php echo @$admin_user['user_pwd'][0];  ?>" /></li>
        ...
        <li class="field"><select name="access_level_id" id="access_level" class="text input">
                             <option value="<?php echo @$access_levels['id'][0];?>">
                                 <?php echo @$access_levels['access_desc'][0];?>
                             </option> 
                          </select><input name="id" type="hidden" value="<?php echo @$admin_user['id'][0];  ?>"></li>
        <li class="field">
...
$(document).ready(function(){
	...
	$('#buttons').click(function(){
		...
		$.ajax({
			 type: "POST",
				   url:	"/postmanager/update_churchadmin_user/",
