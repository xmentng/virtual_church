...
function loadVideoPlayer() {
 ...
 var ua = navigator.userAgent;
   ...
   if(!Ok) {
		//
		 var s2 = new SWFObject('/js/player.swf','ply','640','500','9','#ffffff');
...
<iframe style="width:100%; height:auto; min-height:420px;" src='http://www.coveritlive.com/index2.php/option=com_altcaster/task=viewaltcast/altcast_code=9514244463/width=350/height=450/entryLoc=bottom/commentLoc=bottom/titlePage=off/replayContentOrder=chronological' scrolling='no'  frameBorder ='0' allowTransparency='true' ></iframe>
