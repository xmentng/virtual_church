         ...
         <div class="row cls_landing_page" style="font-size:0.75em; height:60px; background: #FFF; width:100%;">
		   ...
		   <!--end row--> 
            ...
            <div class="row cls_landing_page_content">
				...
				<div class="eight columns cls_lpage_left_col">
 ...
 var ua = navigator.userAgent;
   ...
   if (ua.indexOf("BlackBerry") >= 0)
   {
	...
	if ((navigator.userAgent.match(/iPhone/i)) || (navigator.userAgent.match(/iPod/i)) || (navigator.userAgent.match(/iPad/i)) || (navigator.userAgent.match(/iPad/i))) {
		...
		$('#screen').html('<video src="<?php echo @$church_detail['ipad'][0];    ?>" width="100%" height="400" controls="controls"  autoplay="autoplay" preload></video>');
		 Ok= true; 
    ...
    if ((navigator.userAgent.match(/Android/i))) {
        ...
        $('#screen').html('<video src="<?php echo @$church_detail['android'][0];?>" width="100%" height="100%" controls="controls"  autoplay="autoplay" preload></video>');
         Ok= true; 
...
<script>loadVideoPlayer();</script>
                ...
                <div class="four columns cls_lpage_right_col">
                    ...
                    <code class="<?php echo @$data['blog_css_cls'];   ?> stdfont stdfontcolor" id="post_result_msg"><?php echo @$data['blog_msg']; ?></code>
                      <table width="100%" border="0" cellspacing="0" cellpadding="3" style="color:#666666; font-size:12px;">
                        <tr>
                          ...
                          <td width="88%" bgcolor="#FFFFFF"><input type="text" name="name" id="name" class="cls_txtflds" readonly value="<?php echo @$user_detail['first_name'][0].'  '. $user_detail['last_name'][0]; ?>" style="width: 80%;" /></td>
                          </tr>
                        <tr>
                          <td align="right" valign="top"><strong><span style="color:#FF0000; font-size:10px;color:red;">*</span>Email:</strong></td>
                          <td bgcolor="#FFFFFF"><input type="text" name="email" id="email" class="cls_txtflds" readonly value="<?php echo @$user_detail['email'][0]; ?>" style="width: 80%;"  /></td>
                          </tr>
                        <tr>
                          <td align="right" valign="top"><strong><span style="color:#FF0000; font-size:10px;color:red;">*</span>Phone:</strong></td>
                          <td bgcolor="#FFFFFF"><input type="text" name="phone" id="phone" class="cls_txtflds" required style="width: 80%;"  /></td>
                          </tr>
                        <tr>
                          <td align="right" valign="top"><strong><span style="color:#FF0000; font-size:10px;color:red;">*</span>Country:</strong></td>
                          <td bgcolor="#FFFFFF"><select name="country" id="country" class="cls_txtflds" required style="width: 80%;" >
                        ...
                        <tr>
                          ...
                          <td valign="top" bgcolor="#FFFFFF"><textarea name="comment" id="comment" style="min-height:30px; width:80%" required></textarea></td>
                          </tr>
                        <tr>
                          <td>&nbsp;</td>
                          <td>
                            ...
                            <input type="hidden" name="meeting_type" id="meeting_type" value="2" />
			...
			?>
       		<div id="blogged" style="border:transparent; background-color:#FFFFFF; margin-top:10px;  color:#00293E; font-size:0.75em;">
                ...
                <table width="100%" border="0" cellspacing="0" cellpadding="0">
                  ...
                  <?php for($k = 0; $k < count($comment['id']); $k++): ?>
                  <tr  style="border:dotted 1px #007BB7;">
                    ...
                    <div id="tabs-3">
                      <h3>Take Note</h3>
                        <form action="" method="post" name="frmnote" id="frmnote">
                            ...
                            <textarea name="txtnote" id="txtnote" cols="" rows="" style="min-height:110px; min-width:10%;"> </textarea>
...
function chatWith(chatuser,chatname) {
	...
	window.open("/churchmember/startchat/","_blank", "toolbar=0, menubar=0, scrollbars=0, resizable=0,location=0, directories=0, status=0, width=450, height=400");
