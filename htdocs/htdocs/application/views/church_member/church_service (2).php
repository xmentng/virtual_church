...
<script>loadVideoPlayer();</script>
                    ...
                    <div class="cls_chat_with_cell_leader">
                      ...
                      <a  href="javascript:void(0)" onClick="javascript:chatWith('<?php echo $page_res['church_id'];?>','<?php echo $page_res['church_account_name'];?>')">
...
function chatWith(chatuser,chatname) {
	...
	//alert(chatuser);
	window.open("/chatsystem/startchat/","Virtual Church Chat System", "toolbar=0, scrollbars=0, menubar=0, resizable=0, top=90, left=0, width=450, height=400");
...
function checkChatBoxInputKey(event,chatboxtextarea,chatboxtitle,chatname) {
	...
	if (maxHeight > adjustedHeight) {
		adjustedHeight = Math.max(chatboxtextarea.scrollHeight, a