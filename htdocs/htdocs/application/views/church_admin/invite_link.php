...
<!--main content top-->
  ...
  if(@$data['flag_msg_status']=='input_error')echo '<code id="post_result_msg" class="error"> &nbsp;'.@$data['info_msg'].'</code>';
  ...
  if((@$data['nsaved'] < @$data['ndata'])and(@$data['ndata']!=0) and (@$data['nsaved'] != 0)){
   ...
   ?>
    ...
    <ul>
		...
		<li class="field">
        	<span style="font-size:0.75em;">Title / Subject:</span>
        	<input class="text input" type="text" placeholder="Message Title" name="msg_title" id="msg_title" value="" />
        	<span style="font-size:10px; color:#F00">*</span>
        </li>
		
		
		<li class="field">
        	<span style="font-size:0.75em;">From:</span>
        	<input class="text input" type="text" placeholder="From Christ Embassy Int'l Churches" name="msg_from" id="msg_from" value="" />
        	<span style="font-size:10px; color:#F00">*</span>
        </li>
