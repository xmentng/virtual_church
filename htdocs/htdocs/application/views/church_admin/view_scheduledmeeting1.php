 ...
 <div class="row">
 		<div class="twelve columns" style="font-size:0.875em;">
                ...
                <div class="three columns">
                   <div class="navbasr" style="border:solid 1px #70819C">
                        <ul>
                        	<li class="id_mnu_header" style="background-color:#70819C; color:#FFF;">
                            	<span style="padding:0px 10px;">Create Content</span>
                            </li>
                            
                            <li class="cls_mnu_content">
                            	<a href="javascript:void(0)" id="id_create_cell" class="topopup">
                                <span style="padding:0px 10px;">&rarr; Create Cell</span></a>
                                
                            </li>
                            
                            <li class="cls_mnu_content">
                            	<a href="/churchadmin/cell_leader/creat" class="topopup" id="id_create_cell_leader"><span style="padding:0px 10px;">&rarr; Create Cell Leader</span></a>
                            </li>
                            
                            <li class="cls_mnu_content">
                            	<a href="/churchadmin/cell_outline/upload" class="topopup" id="id_cell_outline"><span style="padding:0px 10px;">&rarr; Upload Cell Outline</span></a>
                             </li>
                             
                             <li class="cls_mnu_content">
                            	<a href="/churchadmin/cellmeeting/schedule" class="topopup" id="id_cell_meeting"><span style="padding:0px 10px;">&rarr; Schedule Cell Meeting</span></a>
                             </li>
                             
                             
                            
                            <li class="id_mnu_header" style="background-color:#70819C; color:#FFF;">
                            	<span style="padding:0px 10px;">View Content</span>
                            </li>
                            
                            <li class="cls_mnu_content">
                            	<a href="/churchadmin/cell/view" id="id_view_cell"><span style="padding:0px 10px;">&rarr; View | Edit Cell</span></a>
                            </li>
                            
                            
                            
                             <li class="cls_mnu_content">
                            	<a href="/churchadmin/cell_leader/view" id="id_view_cell_leader"><span style="padding:0px 10px;">&rarr; View | Edit Cell Leader</span></a>
                             </li>
                             
                             
                             <li class="cls_mnu_content">
                            	<a href="/churchadmin/cellmeeting/view"  id="id_view_scheduled_meeting"><span style="padding:0px 10px;">&rarr; View Sheduled Meeting</span></a>
                             </li>
