...
<!--main content top-->
  ...
  <hr>
    ...
    <br>
    <ul>
        <li class="field"><input class="text input" type="text" placeholder="First Name" name="first_name" id="first_name" value="<?php echo @$user['first_name'][0]; ?>" /></li>
        <li class="field"><input class="text input" type="text" placeholder="Last Name" name="last_name" id="first_name" value="<?php echo @$user['last_name'][0]; ?>" /></li>
        <li class="field"><input class="text input" type="text" placeholder="User Email" name="email" id="email" value="<?php echo @$user['email'][0]; ?>" /></li>
         <li class="field">
        	<select id="country" name="country"  class="text input" required>
                                                <option selected="selected" value="<?php echo @$user['country'][0]; ?>"><?php echo @$user['country'][0]; ?></option>
        ...
        <li class="field"><input class="text input" type="text" placeholder="User Name" name="usn" id="usn" value="<?php echo @$user['user_name'][0]; ?>" /></li>
        <li class="field"><input class="password input" type="password" placeholder="User Password" name="usr_pwd" id="usr_pwd"  value="<?php echo @$user['user_pwd'][0]; ?>" /></li>
        <li class="field"><input name="church_id" type="hidden" value="<?php echo @$user['church_id'][0]; ?>"></li>
        <li class="field">
        				 
                         <select name="access_level_id" id="access_level" class="text input">
                             <option value="<?php echo @$user['access_level_id'][0];?>">
                                 <?php echo @ $data['access_level_desc'];?>
                             </option> 
                          </select>
                          
                          <input name="id" type="hidden" value="<?php echo @$user['id'][0]; ?>"></li>
        <li class="field">
...
$(document).ready(function(){
	...
	$('#buttons').click(function(){
		...
		$.ajax({
			 type: "POST",
				   url:	"/postmanager/update_churchuser_account/",
				   ...
				   success:	function(e){
						...
						var sp = e.split('|');
							...
							if(sp[0] == "success"){
								...
								$('#post_result_msg').html(sp[1]);
								document.location="/churchadmin/useraccount/editaccount/<?php  echo @$data['uid'];   ?>";
								//loadCurrentRecord();
							}//end if
