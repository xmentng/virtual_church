...
<!--main content top-->
  ...
  <div class="messageWr"  style=" padding:5px 0">
             ...
             <div class="cls_sidebar" style="width:30%; float:left;">
              	<div class="cls_rsbar_content" style="border:solid 1px #E0E0E0;">
                    ...
                    <li class="cls_rsbar_menu_content" style="list-style:none; border-bottom:dotted 1px #B0B0B0;">
                        <a href="/churchadmin/cell/create" style="color: #F45000;"><span style="padding:0px 10px; font-size:0.75em;"> &rarr; Create Cell</span></a>
                    </li>
    ...
    <ul>
        ...
        <li class="field">
        	<input name="submit_btn" id="cmdclick" class="pretty  primary btn" type="submit" value="&nbsp; Create Cell &nbsp;" / style="color:#FFF; text-shadow:1px 1px 1px #333; width:auto; padding:2px 7px;"></li>
    </ul>
    </form>
