 		...
 		<div class="twelve columns" style="font-size:0.875em;">
                ...
                <div class="nine columns">
                    ...
                    <p style="line-height:1.8125em; text-align:justify; font-size:11.8px;">
                        ...
                        <div style="font-size:1.625em; font-weight:bolder;">Church Attendance in Summary</div>
                        <hr style=" border-color:#F00;">
  
                      <form action="" method="post" name="frmreport">
                      
                      		<div class="nine colums">
                            	Please select church service date: 
                                <input name="service_date" type="text" id="datepicker"  class="cls_txtflds" style="width:45%;" />
                                <br>
								<input name="cmdgo" type="submit" value="&nbsp;&nbsp;Submit&nbsp;&nbsp;" class="btn pretty primary" style="color:#FFF;">
                            </div>
                            <?php
                            ...
                            <?php   for($i=0; $i<@$data['nattendances']; $i++):  ?>
                            	...
                            	<div class="twelve columns">
                                    ...
                                    <div class="one column">
                                    	<span style="padding:0px 5px;">
                                        <?php  echo $attendanceInfo['total_attendance'][$i];  ?>
                                        </span>
                                    </div>
                                    
                                    <div class="two columns">
                                    	<a href="/churchadmin/report/detailchurchattendance/<?php echo $attendanceInfo['id'][$i] ?>" style="color:#6681A2;">
                                    	<span style="padding:0px 5px;">
                                        	View Detail
                                        </span>
                                        </a>
