...
<span class="style8" style="width:auto; float:right;"><div class="selectRegion">
 ...
 <iframe src="/region/<?php echo Session::get('region').'/'; ?>settings.php" height="340" scrolling="no" width="640" frameborder="0" name="live" id="iframe_live" style="background:#000;"></iframe>
            ...
            <div class="vidsid_boxV">
            	<div id="vidsid_boxV1">
                	<div class="style11" id="noteBtitle_vidsid_boxV1">
                	  <div align="center">NOTICE BOARD</div>
               	  </div>
		...
		<Div clASS=viewport>
			 <diV CLass="overview">
<iframe src='http://www.coveritlive.com/index2.php/option=com_altcaster/task=viewaltcast/altcast_code=f15c4fc585/width=400/height=300/entryLoc=bottom/commentLoc=bottom/titlePage=off' scrolling='no' height='300px' width='339px' frameBorder ='0' allowTransparency='true' ><a href='http://www.coveritlive.com/mobile.php/option=com_mobile/task=viewaltcast/altcast_code=f15c4fc585' >Communion Service</a></iframe>
...
<div id="container">
  <!-- <div id="button" style="font-size:12px;"><strong style=" color:#ccc"><span style=" color:#F00">Click</span> to Change Settings </strong>     !-->
   <a href="/region/<?php echo Session::get('region').'/'; ?>settings.php" target='live'> <strong style=" color:#ccc"><span style=" color:#F00">Click</span> to Change Settings </strong>  </a>
    <ul class="the_menu" style="z-index:1000">
    <div id="celebs" style=" margin-top:-220px; z-index:1000">
<li><a href="/region/<?php echo Session::get('region').'/'; ?>flashlow.php" title='Flash Low'>Flash Low</a></li>
<li><a href="/region/<?php echo Session::get('region').'/'; ?>flashmed.php" title='Flash Medium'>Flash Medium</a></li>
<li><a href="/region/<?php echo Session::get('region').'/'; ?>winlow.php" title='Windows Low'>Windows Low</a></li>
<li><a href="/region/<?php echo Session::get('region').'/'; ?>winmed.php" title='Windows Medium'>Windows Medium</a></li>
<li><a href="/region/<?php echo Session::get('region').'/'; ?>audio.php" title='Audio'>Audio</a></li>
</div>
...
<br />
            	...
            	<div class="style9" id="nav_boxV2" style=" width:400px; font-size:14px"> <span style="float:left"></span> <span class="style8" style="margin-left:10px; float:left" id="biography2"></span> </div>
            </div>
            
            
            <div class="style10" id="helpnav_boxV"> 
              <div align="right"><span class="style13"> +2348024782703, +2348024900443, +2348024308132 (INFINITY)</span></div>
            </span></div>
</div>
    <div class="copr_boxV">
