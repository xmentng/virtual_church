...
function approvevideos(){
	...
	$videos = useraccount::loadDetails('tbl_videos',$arrFilter=array('church_id'=>$this->session->userdata('church_id'), 'approved'=>1),array('id', 'video_name', 'video_title','church_id', 'video_desc', 'video_url', 'video_thumbnail_url', 'video_category', 'approved', 'time_posted'),$num=NULL,$orderBy='');
