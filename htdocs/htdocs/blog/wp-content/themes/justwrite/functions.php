...
if ( ! function_exists( 'ac_js_files' ) ) {
	...
	function ac_js_files() {
		...
		wp_enqueue_script( 'ac_js_myscripts', get_template_directory_uri() . '/assets/js/myscripts.js', array('jquery'), '1.0', true );
		wp_enqueue_script( 'ac_js_html5', get_template_directory_uri() . '/assets/js/html5.js', array('jquery'), '1.0', false );
