...
function chatHeartbeat(){
	...
	$.ajax({
	  url: "/church_service_chat.php?action=chatheartbeat",
	  cache: false,
	  dataType: "json",
...
function closeChatBox(chatboxtitle) {
	...
	$.post("/church_service_chat.php?action=closechat", { chatbox: chatboxtitle} , function(data){	
	});
...
function startChatSession(){ 
	...
	$.ajax({
	  url: "/church_service_chat.php?action=startchatsession",
	  cache: false,
	  dataType: "json",
	  async: false,
	  success: function(data) {
...
//alert(username);
	...
	$.ajax({
	  url: "/church_service_chat.php?action=chatname&usw="+item.f,
	  cache: false,
	  dataType: "json",
	  async: false,
