...
function change_user_password(){
	...
	$usr = strip_tags($_POST['usr_name']);
	
	$user = authmanager::authenticate_user($usr, $prev_pwd);
	...
	if(!$user):
		$flag_ok = false;
		$this->util_lib->display_message($error=array('Incorrect password'), $msg_type='failure', $img_source='/images/icons/invalid_small.png');exit;
	endif;
