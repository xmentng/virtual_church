...
<span class="style8" style="width:auto; float:right;"><div class="selectRegion">
 ...
 <iframe src="/region/<?php echo Session::get('region').'/'; ?>settings.php" height="340" scrolling="no" width="640" frameborder="0" name="live" id="iframe_live" style="background:#000;"></iframe>
		...
		<Div clASS=viewport>
			 <diV CLass="overview">
<iframe src="http://www.coveritlive.com/index2.php/option=com_altcaster/task=viewaltcast/altcast_code=06375595c7/height=400/width=339" scrolling="no" height="480px" width="339px" frameBorder ="0" allowTransparency="true"  ><a href="http://www.coveritlive.com/mobile.php/option=com_mobile/task=viewaltcast/altcast_code=06375595c7" >Communion Service Test Transmission</a></iframe>
...
<br />
            ...
            <div class="style10" id="helpnav_boxV"> +2348024900375, +2348024782703, +2348032266563(INFINITY)</span></div>
</div>
    <div class="copr_boxV">
