...
<div style="margin:0px; font-style:italic; font-size:9px; color:#CCCCCC">
 ...
 <!--<iframe src="http://www.coveritlive.com/index2.php/option=com_altcaster/task=viewaltcast/altcast_code=81f931ce86/height=390/width=270" scrolling="no" height="390px" width="270px" frameBorder ="0" allowTransparency="true"  ><a href="http://www.coveritlive.com/mobile.php/option=com_mobile/task=viewaltcast/altcast_code=81f931ce86" >August Communion Service</a></iframe>-->
      <iframe src="http://www.coveritlive.com/index2.php/option=com_altcaster/task=viewaltcast/altcast_code=e118a1def3/height=390/width=270" scrolling="no" height="390px" width="270px" frameBorder ="0" allowTransparency="true" ><a href="http://www.coveritlive.com/mobile.php/option=com_mobile/task=viewaltcast/altcast_code=e118a1def3" >August Communion Service Test Transmission</a></iframe>
