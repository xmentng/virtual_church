						...
						<div class="tabs-main">
							...
							<div class="tab-content">
                                <div class="tab-pane active" id="pInfo">
                                    <div style='display:none;'>Live Blog Chat with Pastor Segun</div><div id='cil-root-stream-7b06b7abdd' class='cil-root'><span class='cil-config-data' title='{"altcastCode":"7b06b7abdd","server":"www.coveritlive.com","geometry":{"width":"fit","height":700},"configuration":{"newEntryLocation":"top","commentLocation":"top","replayContentOrder":"chronological","pinsGrowSize":"on","titlePage":"off","embedType":"stream","titleImage":"/templates/coveritlive/images/buildPage/DefaultImage.jpg"}}'>&nbsp;</span></div><script type='text/javascript'>window.cilAsyncInit = function() {cilEmbedManager.init()};(function() {if (window.cilVwRand === undefined) { window.cilVwRand = Math.floor(Math.random()*10000000); }var e = document.createElement('script');e.async = true;var domain = (document.location.protocol == 'http:' || document.location.protocol == 'file:') ? 'https://cdnsl.coveritlive.com' : 'https://cdnslssl.coveritlive.com';e.src = domain + '/vw.js?v=' + window.cilVwRand;e.id = 'cilScript-7b06b7abdd';document.getElementById('cil-root-stream-7b06b7abdd').appendChild(e);}());</script>
                                </div>
