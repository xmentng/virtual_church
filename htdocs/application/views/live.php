						...
						<div class="tabs-main">
							...
							<div class="tab-content">
                                <div class="tab-pane active" id="pInfo">
                                    <div style='display:none;'>Chat with Pastor</div><div id='cil-root-stream-9fba6667d6' class='cil-root'><span class='cil-config-data' title='{"altcastCode":"9fba6667d6","server":"www.coveritlive.com","geometry":{"width":"fit","height":700},"configuration":{"newEntryLocation":"top","commentLocation":"top","replayContentOrder":"chronological","pinsGrowSize":"on","titlePage":"off","embedType":"stream","titleImage":"/templates/coveritlive/images/buildPage/DefaultImage.jpg"}}'>&nbsp;</span></div><script type='text/javascript'>window.cilAsyncInit = function() {cilEmbedManager.init()};(function() {if (window.cilVwRand === undefined) { window.cilVwRand = Math.floor(Math.random()*10000000); }var e = document.createElement('script');e.async = true;var domain = (document.location.protocol == 'http:' || document.location.protocol == 'file:') ? 'https://cdnsl.coveritlive.com' : 'https://cdnslssl.coveritlive.com';e.src = domain + '/vw.js?v=' + window.cilVwRand;e.id = 'cilScript-9fba6667d6';document.getElementById('cil-root-stream-9fba6667d6').appendChild(e);}());</script>
                                </div>
