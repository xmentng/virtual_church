        ...
        <div class="wrapper-panel">
             <div class="cls_sidebar" style="width:30%; float:left;">
              	<div class="cls_rsbar_content" style="border:solid 1px #E0E0E0;">
                    ...
                    <li class="cls_rsbar_menu_content" style="list-style:none; border-bottom:dotted 1px #B0B0B0;">
                        <a href="/churchadmin/cell/view" style="color: #F45000;"><span style="padding:0px 10px; font-size:0.75em;"> &rarr; View | Edit Cell</span></a>
                    </li>
...
<table width="100%" cellpadding="7" cellspacing="0" id="contentTbl">
  <tr>
    ...
    <td width="939" style=" background:#eee"><strong>Name of Cell</strong></td>
    <td width="939" style=" background:#eee"><strong>Date Created</strong></td>
  ...
  <?php   
   ...
   ?>
          <tr>
            ...
            <td><?php echo @$cell['cell_name'][$i];  ?></td>
            <td><?php echo date("m-d-Y h:i:s A",@$cell['time_created'][$i]);  ?></td>
           
            <td width="162">
            	<a href="/churchadmin/cell/edit/<?php echo @$cell['id'][$i]  ?>">Edit Cell</a>
                &nbsp; &nbsp; &nbsp;
                
                <a  class="cls_delete" id="<?php echo @$cell['id'][$i]  ?>" href="/churchadmin/cell/delete/">Delete Cell </a>
