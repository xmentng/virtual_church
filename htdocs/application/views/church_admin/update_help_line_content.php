...
<!--main content top-->
  ...
  <div class="clearfix"></div>
    ...
    <h4  style=""> 
 <i class="icon-doc-text-inv" ></i> <span>Update</span> 
 </h4>
  <hr>
  ...
  <div class="four columns"  style=" padding:5px 0;">
    	...
    	<div class="cls_rsbar_content" style="margin-left:15px; margin-top:14px;  border:solid 1px #E0E0E0;">
            ...
            <li class="cls_rsbar_menu_content" style="list-style:none;">
            	<a href="/churchadmin/helplines/add/" style="color:#000;"><span style="padding:0px 10px; font-size:0.75em;"> &rarr; Add Notice Board Contents</span></a>
            </li>
            ...
            <li class="cls_rsbar_menu_content" style="list-style:none;">
            	<a href="/churchadmin/help_line_content/edit" style="color:#000;"><span style="padding:0px 10px; font-size:0.75em;"> &rarr; Edit Notice Board Contents</span></a>
            </li>
    ...
    <ul>
        <li class="field">
          <input name="notice_board_content" type="text" class="cls_notice_board  text  input " id="notice_board_content" value="<?php echo @$nbcontent['help_line'][0];   ?>" placeholder="Help Line">
...
$(document).ready(function(){
	...
	$('#buttons').click(function(){
		...
		$.ajax({
			   type: "POST",
			   		url:	"/postmanager/proc_edited_help_line_content",
					...
					success:	function(e){
							...
							if(sp[0] == "success"){
								...
								$('html, body').animate({scrollTop:0}, 'slow');
								$('#this-form')[0].reset();
								document.location="/churchadmin/help_line_content/update/<?php echo @$nbcontent['id'][0];   ?>";
							}//end if
