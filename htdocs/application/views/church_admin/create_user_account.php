...
<!--main content top-->
  ...
  <hr>
    ...
    <br>
    <ul>
        <li class="field"><input class="text input" type="text" placeholder="First Name" name="first_name" id="first_name" style="width:75%;" /></li>
        <li class="field"><input class="text input" type="text" placeholder="Last Name" name="last_name" id="first_name" style="width:75%;" /></li>
        <li class="field"><input class="text input" type="text" placeholder="User Email" name="email" id="email" style="width:75%;" /></li>
        <li class="field">
        	<select id="country" name="country"  class="text input" required  style="width:75%;">
        ...
        <li class="field"><input class="text input" type="text" placeholder="User Name" name="usn" id="usn" style="width:75%;" /></li>
        
        <li class="field"><input class="password input" type="password" placeholder="User Password" name="usr_pwd" id="usr_pwd" style="width:75%;" /></li>
        <li class="field"><input name="church_id" type="hidden" value="<?php echo @$adminUser['church_id'][0]; ?>"></li>
        <li class="field"><select name="access_level_id" id="access_level" class="text input">
                             <option value="3" style="width:75%;">
