...
<!--main content top-->
  ...
  <div class="messageWr"  style=" padding:5px 0">
    ...
    <ul>
        ...
        <li class="field">
        	<input name="submit_btn" id="cmdclick" class="pretty  primary btn" type="submit" value="&nbsp; Create Cell Leader &nbsp;" / style="color:#FFF; text-shadow:1px 1px 1px #333; width:auto; padding:2px 7px;"></li>
    </ul>
    </form>
