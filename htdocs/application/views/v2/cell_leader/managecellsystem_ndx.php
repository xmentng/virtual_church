 ...
 <div class="row">
 		<div class="twelve columns" style="font-size:0.875em;">
                ...
                <div class="nine columns" style="border:solid 1px #70819C;  padding:0px 15px;">
                  ...
                  <form  method="post" name="frmvideo" id="frmvideo" enctype="multipart/form-data" class="upload">
                       	
                   	  
                       	   <h4>Welcome To the Administrative Control Panel.</h4>
                               ...
                               <tr>
                                 <td colspan="2" align="left" valign="top">
									 ...
									 <p STYLE="font-size:13px;">
										...
										This administrative panel provides the enumerated functionalities to the user:
										<br>
										<br>
										1.	Add new cell members to your cell
										<br>
										<br>
										2.	Starts and view cell meetings
										<br>
										<br>
										3.	Upload and view Cell Outlines
										<br>
										<br>
										4.	Upload and view announcements
										<br>
										<br>
										5.	Generate links for social media publicity
										<br>
										<br>
										6.	View cell meetings attendance register
