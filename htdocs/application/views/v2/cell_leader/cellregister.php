	    			...
	    			<div style="font-size:12px;" class="info col-md-9"><?php  echo $data['info_msg'];  ?></div>
					 ...
					 <p style="line-height:1.8125em; text-align:justify; font-size:11.8px;">
                      ...
                      <form action="" method="post" name="frmreport">
							...
							?>
							<div class="row">
                            	<div class="col-md-12" style="background-color:#ddd; color:#000; margin-bottom:5px;">
                                	<div class="">
                            ...
                            <div class="row">
                            	<div class="col-md-12" style="background-color:#6681A2; color:#333; margin-bottom:5px;">
                                	<div class="col-md-1">
                                    	<span style="padding:0px 5px;">
                                        S|No.
                                        </span>
							...
							?>
                              ...
                              <div class="row">
                            	<div class="col-md-12" style="border-bottom: solid 1px #BBC6D0;">
                                	<div class="col-md-1">
                                    	<span style="padding:0px 5px;">
                                        <?php  echo ++$sn;  ?>
                                        </span>
