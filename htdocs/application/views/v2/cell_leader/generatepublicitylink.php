                ...
                <p style="line-height:1.8125em; text-align:justify; font-size:11.8px;">
                     ...
                     <form action="" method="post" name="frmpost" id="frmpost">
						   ...
						   <code class="info" id="post_result_msg_cell">
							   Please click on the generate button to create the social publicity link.
						   </code>
								
						<ul>
							<li class="field">Generate Link:<br>
								<input class="text input" type="text" placeholder="" name="splink" id="splink" style="width:75%;" /></li>
							
							<li class="field">
        	<input name="cmdclick" id="cmdclick" class="pretty medium primary btn" type="submit" value="&nbsp;Generate &nbsp;"  style="color:#FFF; text-shadow:1px 1px 1px #333; width:auto; padding:2px 7px;"></li>
