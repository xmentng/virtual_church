					...
					<div class="col-sm-3">
		                <section class="panel">
		                    <div class="panel-body">
		                    	<h4 style="font-weight:bold;">CHAT MEMBERS</h4>
                           ...
                           <div class=" form">
								...
								<form class="cmxform form-horizontal " id="frmchat" method="post" action="">
                                    ...
                                    <div class="form-group ">
                                        ...
                                        <div class="col-lg-9">
											<div class="refresh  text input" id="" style="width:98%;border:solid 1px #ddd; height:250px;  overflow:scroll; padding:2px 7px;"></div>
