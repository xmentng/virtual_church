...
////////////////////////////////////////////
	...
	$(".refresh").everyTime(400,function(i){
			$.ajax({
			  url: "/churchmember/refreshchatpost/<?php echo @$data['chat_admin_account'];   ?>",
			  cache: false,
	...
	$('#cmd_post_chatmsg').click(function(){
		//var receiver = <?php  //echo $page_res['church_account_name'];  ?>;
		$.ajax({
			 type: "POST",
				   url:	"/churchmember/savechatpost ",
...
<input name="sender" type="text" id="texta" value="Chat Name: <?php echo @$page_res['name_of_user'] ?>" readonly="readonly" style="font-weight:bolder;"/>
<input name="user_full_name" type="text" id="texta" value="Conversation with : <?php echo @$data['chat_admin_user']." - Admin";   ?>" readonly="readonly" style="font-weight:bolder;"/>


<input name="sender_account_name" type="hidden" id="texta" value="<?php echo @$page_res['user_id'] ?>" readonly="readonly" style="font-weight:bolder;"/>
<input name="receiver_account_id" type="hidden" id="texta" value="<?php echo @$data['chat_admin_account'];   ?>" readonly="readonly" style="font-weight:bolder;"/>
