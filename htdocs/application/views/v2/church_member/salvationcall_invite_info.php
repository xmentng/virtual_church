				...
				?>
                	 <div class="row">
                            	<div class="twelve columns" style="border-bottom:dashed 1px #6681A2">
                                    ...
                                    <div class="two columns">
                                    	<span style="padding:0px 5px;">
                                        	<?php  echo @$invites['invite_name'][$i];  ?>
                                        </span>
                                    </div>
                                    ...
                                    <div class="four columns">
                                    	...
                                    	<span style="padding:0px 5px;">
                                        	<?php  echo @$invites['invite_email'][$i];  ?>
                                        </span>
                                    ...
                                    <div class="two columns">
                                    	<span style="padding:0px 5px">
                                        	<?php  echo @$invites['invite_country'][$i];  ?>
                                        </span>
                                    </div>
...
<div class="one column">
                                        ...
                                        <span style="padding:0px 5px;">
                                        	<?php  
												if(@$invites['accept_call'][$i]==1):
													echo "Yes";
												endif;
												if(@$invites['accept_call'][$i]==0):
													echo "No";
												endif;
                                    ...
                                    <div class="two columns">
                                    	...
                                    	<a href="javascript:void(0)" onClick="javascript:sendSalvationMail('<?php  echo @$invites['id'][$i];  ?>')">
                                        <span style="padding:0px 5px;">
											Re-send salvation call mail
                                        </span>
                                        </a>
										<?php
