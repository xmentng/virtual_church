    ...
    <div class="row" id="maintab" style="height:60px;">
     ...
     <div class="row" id="page-contents">
        ...
        <div class="twelve columns latest_video_videoplayer" style="width:100%; background-color:#282828; height:auto; color:#B3B3B3; font-size:11px;">
             	...
             	<div class="six columns" id="default-video" style="background-color:#333">
...
<script>loadVideoPlayer();</script>
         ...
         <div class="six columns" id="video-info" style="background-color:#333">
                 ...
                 <div style="margin-top:10px">
				   ...
				   /*if(!$data['def_thumb']):
					...
					echo '<img src="'.$data['def_thumb'].'" style="float:left; clear:left; margin-right:2px; width:50%; height:125px;" />';
				
				   ?>
                   <!--<img src='<?php //echo $src;   ?>' style="float:left; clear:left; margin-right:2px; width:35%;" />-->
                   <p style="padding:0px 7px;">
                   		<?php if(@$defaultvideo['video_thumbnail_url'][0]){echo "<strong>Video Title:</strong> <br>".@$defaultvideo['video_title'][0];}else{ echo "<strong>Title: </strong><br>Pastor Chris Teachings"; }  ?>
                     <br>
                     	<?php  if(@$defaultvideo['video_thumbnail_url'][0]){ echo "<strong>Description:</strong> <br>". @$defaultvideo['video_desc'][0];}else{ echo "<strong>Description:</strong><br>Great messages from Pastor Chris";  } ?>
                   </p>
                </div>   
          </div>
            	...
            	<div class="row">
                 ...
                 <div class="row" id="video-comment-section">
                  ...
                  <div class="twelve columns" id="video-comment-form">
                           <iframe style="width:100%;" src='http://www.coveritlive.com/index2.php/option=com_altcaster/task=viewaltcast/altcast_code=8358f6f8cc/width=470/height=550/entryLoc=bottom/commentLoc=bottom/titlePage=off/replayContentOrder=chronological'scrolling='no' height='550px'  frameBorder ='0' allowTransparency='true' ></iframe>
                    </div><!--end 12 cols-->
                 </div><!--end row-->
