...
////////////////////////////////////////////
	...
	$('#cmd_post_chatmsg').click(function(){
		var receiver = <?php useraccount::getLastAttributeValue(array('admin_account'), $tblname="tbl_admin_and_user_chat_cn", array('user_account'=>$page_res['logged_in_account']), $retval="admin_account");   ?>
		$.ajax({
			 type: "POST",
				   url:	"/chatsystem/savepost/"+receiver,
...
<input name="sender" type="text" id="texta" value="Chat Name: <?php echo @$page_res['logged_in_account'] ?>" readonly="readonly" style="font-weight:bolder;"/>
