...
<head>
    ...
    <link rel="shortcut icon" href="/v2_images/favicon.png">

    <title>Welcome! - Christ Embassy Virtual Church</title>
    
    <!-- Countdown CSS -->
    <link href="/v2_css/bootstrap.css" rel="stylesheet">
    <link href='http://fonts.googleapis.com/css?family=Open+Sans:400,300,600,800' rel='stylesheet' type='text/css'>
 
	<link href="/v2_css/main.css" rel="stylesheet" media="all">


    <link href="/v2_cssbootstrap.min.css" rel="stylesheet">
    <link href="/v2_css/bootstrap-reset.css" rel="stylesheet">
    <link href="/font-awesome/css/font-awesome.css" rel="stylesheet" />

    <!-- Custom styles for this template -->
    <link href="/v2_css/style.css" rel="stylesheet">
    <link href="/v2_css/style-responsive.css" rel="stylesheet" />
...
<?php $this->load->view('v2/church_admin/headmast')  ?>
</header>
<!--header end-->
<aside>
    <div id="sidebar" class="nav-collapse">
        <!-- sidebar menu start-->            
		<?php $this->load->view('v2/church_admin/left_sidebar')  ?>
    </div>
</aside>
<!--sidebar end-->
    <!--main content start-->
                    ...
                    <div class="panel-body profile-information">
                       <div class="col-md-3">
                           <div class="profile-pic text-center">
                               <img src="/v2_images/lock_thumb.jpg" alt=""/>
                           </div>
                       </div>
                       <div class="col-md-9">
                                        ...
                                        <div class="recent-act">
                                          ...
                                          <div class="activity-desk" style="margin-top:15px;">
                                            ...
                                            <div class="activity-desk">
                                                ...
                                                <div class="photo-gl">
                                                    <a href="#">
                                                        <img src="/v2_images/sm-img-1.jpg" alt=""/>
                                                    </a>
                                                    <a href="#">
                                                        <img src="/v2_images/sm-img-2.jpg" alt=""/>
                                                    </a>
                                                    <a href="#">
                                                        <img src="/v2_images/sm-img-3.jpg" alt=""/>
                                                    </a>
                                                </div>
                                            </div>
...
God bless you.</p>
        ...
        <!--chat start-->
        <section class="panel" style="padding:1%; background-color:#0f5195; background-image:url(/v2_images/countdown_bkgr.jpg);">
                    ...
                    <ul class="conversation-list">
                      ...
                      <li class="clearfix">
                            <div class="chat-avatar">
                                <img src="/v2_images/avatar-pastor.jpg" alt="male">
                                <i>10:00</i>
                          </div>
...
<li class="widget-collapsible">
    <a href="#" class="head widget-head terques-bg active clearfix">
        <span class="pull-left"> online members (5)</span>
        <span class="pull-right widget-collapse"><i class="ico-minus"></i></span>
    </a>
    <ul class="widget-container">
        <li>
            <div class="prog-row">
                <div class="user-thumb">
                    <a href="#"><img src="/v2_images/avatar1_small.jpg" alt=""></a>
                </div>
            ...
            <div class="prog-row">
                <div class="user-thumb">
                    <a href="#"><img src="/v2_images/avatar1.jpg" alt=""></a>
                </div>
                <div class="user-details">
            ...
            <div class="prog-row">
                <div class="user-thumb">
                    <a href="#"><img src="/v2_images/chat-avatar2.jpg" alt=""></a>
                </div>
                <div class="user-details">
...
<!--Core js-->
<script src="/v2_js/jquery.js"></script>
<script src="/v2_js/bootstrap.min.js"></script>
<script class="include" type="text/javascript" src="/v2_js/jquery.dcjqaccordion.2.7.js"></script>
<script src="/v2_js/jquery.scrollTo.min.js"></script>
<script src="/v2_js/jQuery-slimScroll-1.3.0/jquery.slimscroll.js"></script>
<script src="/v2_js/jquery.nicescroll.js"></script>

<!--common script init for all pages-->
<script src="/v2_js/scripts.js"></script>

<script src="/v2_js/jquery-1.9.0.min.js"></script>
...
<script src="/v2_js/countdown.js"></script>
<script type="text/javascript">
