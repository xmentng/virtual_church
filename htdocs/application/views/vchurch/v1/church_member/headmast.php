...
<div class="brand">
    ...
    <a href="index_home.html" class="logo" style="margin-top:-18px;">
        <img src="/vchurch/v2_images/logo.png" alt="">
    </a>
    ...
    <ul class="nav top-menu">
        ...
        <li id="header_inbox_bar" class="dropdown">
            ...
            <ul class="dropdown-menu extended inbox">
                ...
                <!--<li>
                    <a href="#">
                        <span class="photo"><img alt="avatar" src="/vchurch/v2_images/avatar-mini-2.jpg"></span>
                                <span class="subject">
                ...
                <li>
                    <a href="#">
                        <span class="photo"><img alt="avatar" src="/vchurch/v2_images/avatar-mini-3.jpg"></span>
                                <span class="subject">
                ...
                <li>
                    <a href="#">
                        <span class="photo"><img alt="avatar" src="/vchurch/v2_images/avatar-mini.jpg"></span>
                                <span class="subject">
    ...
    <ul class="nav pull-right top-menu">
        ...
        <li class="dropdown">
            <a data-toggle="dropdown" class="dropdown-toggle" href="#">
                <img alt="" src="<?php echo CUSTOM_BASE_URL.$this->session->userdata('profile_pic');   ?>">
