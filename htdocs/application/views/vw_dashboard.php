...
It is a platform designed to take the gospel of our Lord Jesus Christ according to Believers LoveWorld to the ends of the earth and creates opportunities to expand our reach and ignite the fire of cyber evangelism throughout the world. 
     ...
     <div class=" righttxt">Already have an account?<br>
		<span style="font-size:13px; font-weight:bold;">Sign in</span>
	</div>
    <div class="signin">
        ...
        <form action="" method="post" name="frmlogin" style="padding:1px 7px;" id="this-form">
            ...
            <ul>
                ...
                <li class="field"><input name="submit_btn" id="buttons" class="" type="submit" value="Sign in" style="background-color:#419efd; color:#fff; font-weight:bold; padding-top:8px; padding-bottom:8px;"></li>
				
				<li class="field"><input name="submit_btn" id="register" class="" type="submit" value="Register" style="background-color:#419efd; color:#fff; font-weight:bold; padding-top:8px; padding-bottom:8px;"></li>
				
				<li class="field"><input name="cmdforgotpwd" id="cmdforgotpwd" class="" type="submit" value="Forgot Password?" style="background-color:#419efd; color:#fff; font-weight:bold; padding-top:8px; padding-bottom:8px; cursor:pointer;"></li>
