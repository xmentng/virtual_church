                    ...
                    <code class="<?php echo @$data['blog_css_cls'];   ?> stdfont stdfontcolor" id="post_result_msg"><?php echo @$data['blog_msg']; ?></code>
                      <table width="100%" border="0" cellspacing="0" cellpadding="3" style="color:#666666; font-size:12px;">
                        <tr>
                          ...
                          <td width="88%" bgcolor="#FFFFFF"><input type="text" name="name" id="name" class="cls_txtflds" readonly value="<?php echo @$user_detail['first_name'][0].'  '. $user_detail['last_name'][0]; ?>" style="width:75%;" /></td>
                          </tr>
                        <tr>
                          <td align="right" valign="top"><strong><span style="color:#FF0000; font-size:10px;color:red;">*</span>Email:</strong></td>
                          <td bgcolor="#FFFFFF"><input type="text" name="email" id="email" class="cls_txtflds" readonly value="<?php echo @$user_detail['email'][0]; ?>" style="width:75%;" /></td>
                          </tr>
                        <tr>
                          <td align="right" valign="top"><strong><span style="color:#FF0000; font-size:10px;color:red;">*</span>Phone:</strong></td>
                          <td bgcolor="#FFFFFF"><input type="text" name="phone" id="phone" class="cls_txtflds" required style="width:75%;" /></td>
                          </tr>
                        <tr>
                          <td align="right" valign="top"><strong><span style="color:#FF0000; font-size:10px;color:red;">*</span>Country:</strong></td>
                          <td bgcolor="#FFFFFF"><select name="country" id="country" class="cls_txtflds" required style="width:75%;">
                    ...
                    <div id="tabs-3">
                      <h3>Take Note</h3>
                        <form action="" method="post" name="frmnote" id="frmnote">
                            ...
                            <textarea name="txtnote" id="txtnote" cols="" rows="" style="max-width:100%; min-height:160px; min-width:80%;"> </textarea>
