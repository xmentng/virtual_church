    ...
    <div class="row" id="maintab">
     ...
     <div class="row">
     	...
     	<div class="twelve columns" id="related-videos-thumbnail"  style="height:auto; color:#B3B3B3; background:url(/images/related_video_thumbs_bg.jpg) repeat-x">
			...
			?>
        	<div class="two columns" style="text-align:center; height:auto;">
            	<a href="/churchmember/videos/index/<?php echo $videos['video_code'][$i];   ?>/<?php echo date('d', $videos['video_code'][$i])  ?>/<?php  echo date('m',$videos['video_code'][$i]);  ?>/<?php echo date('Y', $videos['video_code'][$i]);   ?>">
                   <!-- <div class="cls-img" style="height:70px; width:60%; clear:both;">-->
                        <img src="<?php echo "/".$videos['video_thumbnail_url'][$i];   ?>"  style="width:92%; border:none; margin-top:10px;"  align="absmiddle"/>
        <!--</div>-->
                	<br>
     ...
     <div class="row">
     	...
     	<div class="twelve columns" id="video-page-content">
                           ...
                           <div class="latest-videos-mnu-header" style="height:30px; line-height:28px; background-color:#1D66A6; margin-bottom:5px; color:#FFF;">
                            ...
                            <?php
								for($k=0; $k<count($videos['id']); $k++):
									if(($videos['video_category'][$k] != "featured") and (time()-$videos['video_code'][$k])<(60*60*24*2))	{
										
							?>
                            <div class="two columns" style="">
                                
                                <a href="">
                                	<img src="<?php  echo "/".$videos['video_thumbnail_url'][$k];   ?>" style="width:100%; clear:both;" align="absmiddle" />
                                	<br>
            ...
            <div class="three columns" id="rhs-content" style="font-size:11px;">
            	...
            	<div class="featured-video-mnu-header" style="width:100%; height:30px; line-height:28px; background-color:#EB9961; margin-bottom:5px;">
