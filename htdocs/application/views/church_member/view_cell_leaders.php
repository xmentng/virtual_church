...
<!--main content top-->
 ...
 <div class="row">
 	...
 	<div class="twelve columns">
    	...
    	<div class="cls_maintab" style="width:100%; height:25px; line-height:25px;background:#E8E8E8;margin-bottom:6px; z-index:200">
                            ...
                            <form method="post" id="frmpost" name="frmpost">
                                ...
                                <div class="row" style="background-color:#70819C; color:#FFF;">
                                    <div class="twelve columns">
                                      ...
                                      <?php
									  	if(count(@$cell_leader['id']) > 0 ){
									  	$sn = 0;
									  	for($i =0; $i < count(@$cell_leader['id']); $i++){
									  		++$sn;
									  ?>
                                      ...
                                      <div class="row" style="border-bottom:solid 1px #70819C; margin-bottom:2px; margin-top:2px;">
                                        <div class="twelve columns">
                                            ...
                                            <div class="three columns">
                                                <span><?php echo @$cell_leader['cell_name'][$i];    ?></span>
                                            </div>
                                            
                                            <div class="three columns">
                                                <span><?php echo @$cell_leader['first_name'][$i]. " " .@$cell_leader['last_name'][$i];    ?></span>
                                            </div>
                      
                                            <div class="three columns">
                                                <span><?php echo @$cell_leader['cell_leader_email'][$i];    ?></span>
                                            </div>
                                            
                                            <div class="two columns">
                                                <span><?php echo @$cell_leader['country'][$i];    ?></span>
                                            </div>
                                            
                                            <div class="one columns">
                                                <span><img src="<?php echo @$cell_leader['profile_pic'][$i];    ?>" style="width:40%; height:auto;" /></span>
                                            </div>
                                         </div>  
                                	</div>
                                      ...
                                      <div class="row" style="border-bottom:solid 1px #70819C; margin-bottom:2px; margin-top:2px;">
                                        <div class="twelve columns">
                                        	A cell leader is yet to b appointed.
                                        </div>
                                      </div>  
                             ...
                             <?php  if(@$data['n_cell_leaders'] > 0 ){  ?>
                              <div class="wrapper-paging" style="width:100%;">
                                  <ul>
