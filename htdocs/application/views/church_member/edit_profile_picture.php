...
<div class="container ">
            ...
            <div class="row  cls_landing_page_content" style="margin-top:3%;">
                ...
                <div class="eight columns 65perc_col_content" >
                    ...
                    <div class="cls_actual_content" style="width:100%; background:#E8E8E8; height:auto;margin:5px 0px 5px 0px; ">
                    		<form action="/churchmember/uploadpicture" method="post" name="frmpost" id="frmpost" enctype="multipart/form-data" onSubmit="return AIM.submit(this, {'onStart' : startCallback, 'onComplete' : completeCallback})">
    ...
    <br>
    <ul>
        <li class="field" style="padding:0px 10px;"><input type="file" name="picture" id="picture" style="width:75%;"> </li>
