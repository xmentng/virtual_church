...
<!--main content top-->
 ...
 <div class="row">
 		<div class="twelve columns" style="font-size:0.875em;">
                ...
                <div class="nine columns" style=" border:solid 1px #70819c; font-size:11px;">
                	

                    
                    <p style="line-height:1.8125em; text-align:justify; font-size:11.8px; padding:0px 10px;">
                    	<br>
<span style="font-size:1.625em; font-weight:bolder; margin-top:5px;">Manage Video File Contents</span>
                    <br>
						<br>
 
                        This utility allows churches to manage video on  demand. The system allows church admin to:
                        <br>
                        <br>
                       
						1. Upload video file contents.
                        <br>
                        <br>

                        2. Upload video thumbnail or picture content
                        <br>
                        <br>
                        3. Approve uploaded video file contents 
                        <br>
                        <br>
