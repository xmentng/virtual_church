 ...
 <div class="row">
 		<div class="twelve columns" style="font-size:0.875em;">
                ...
                <div class="nine columns" style="border:solid 1px #70819C;  padding:0px 15px;">
                  ...
                  <form action="/videos/uploadvideothumbnail" method="post" name="frmvideo" id="frmvideo" enctype="multipart/form-data" class="upload" onSubmit="return AIM.submit(this, {'onStart' : startCallback, 'onComplete' : completeCallback})">
                       	
                   	   <code class="info" id="post_result_msg">
                       	   Please fill the form below. Kindly note that only jpg, png, gif file formats are currently supported.
                       </code>
                        ...
                        <table width="100%" border="0" cellspacing="0" cellpadding="0">
                               ...
                               <tr>
                                 <td width="22%" align="left" valign="top">Select video thumbnail file to upload:</td>
                               ...
                               <tr>
                                 <td align="left" valign="top">Select video:</td>
                                 <td align="left" valign="top">
                                 <select name="lstvideos" id="lstvideos" style="width:75%;" required>
                                 	<option value=""></option>
                                    <?php
										if($data['nvideos'] > 0){
											for($i=0;$i<$data['nvideos']; $i++):
											
									?>
                                    <option value="<?php echo $videoInfo['video_code'][$i];  ?>"><?php echo $videoInfo['video_title'][$i];  ?></option>
