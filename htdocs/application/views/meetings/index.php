...
<title>...::: WELCOME TO CHRIST EMBASSY ONLINE:: SCHEDULED MEETINGS:::...</title>
  ...
  if(is_array($meetingInfo)){
      ...
      for($a=0;$a<$totalSize;$a++){
		  ...
		  echo "<div class='divWrap'>";
			...
			//echo "<div class='timeDiv' style='font-size:11px;'><a href='/churchsystem/conductmeeting/".$meetingInfo['meetingID'][$a]."'>Start Meeting</a> | <a href='/churchsystem/deletemeeting/".$meetingInfo['meetingID'][$a]."'>Delete Meeting</a></div>";
    		echo "</div>";
  		...
  		echo "<div class='info'>You have no scheduled meetings.</div>";
  }
?>
    </div>
