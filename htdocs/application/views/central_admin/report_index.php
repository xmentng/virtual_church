 		...
 		<div class="twelve columns" style="font-size:0.875em;">
                   ...
                   <div class="navbasr" style="border:solid 1px #70819C; font-size:11.8px;">
                        <ul>
                            ...
                            <li class="id_mnu_header" style="background-color:#70819C; color:#FFF;">
                            	<span style="padding:0px 10px;">Church Attendance Report</span>
                            </li>
                            
                            <li class="cls_mnu_content">
                            	<a href="/report/churchattendance/?mode=total" id="id_create_cell" class="topopup">
                                <span style="padding:0px 10px;">&rarr; Total Church Service Attendance</span></a>
                                
                            </li>
                            
                            <li class="cls_mnu_content">
                            	<a href="/report/churchattendance/?mode=bychurch"  id="id_create_cell_leader"><span style="padding:0px 10px;">&rarr; Attendance By Churches</span></a>
                            </li>
                            ...
                            <li class="id_mnu_header" style="background-color:#70819C; color:#FFF;">
                            	<span style="padding:0px 10px;">Church Service Chat Report</span>
                            </li>
                            
                            <li class="cls_mnu_content">
                            	<a href="/report/churchsystem/?mode=servicechatcomments" id="id_create_cell" class="topopup">
                                <span style="padding:0px 10px;">&rarr; Church Service Chat Comments</span></a>
                                
                            </li>
                            
                            <li class="cls_mnu_content">
                            	<a href="/report/churchsystem/?mode=totalchatcomments"  id="id_create_cell_leader"><span style="padding:0px 10px;">&rarr; Total Chat Comments</span></a>
                            </li>
                            
                            <li class="cls_mnu_content">
                            	<a href="/report/churchsystem/?mode=chatcommentsbychurch"  id="id_cell_outline"><span style="padding:0px 10px;">&rarr; Chat Comments By Churches</span></a>
                             </li>
                             
                            
                            
                            <!--Cell Meeting Attendance Report-->
                            
                            <li class="id_mnu_header" style="background-color:#70819C; color:#FFF;">
                            	<span style="padding:0px 10px;">Cell Meeting Attendance Report</span>
                            </li>
                            
                            <li class="cls_mnu_content">
                            	<a href="/report/cellmeetingattendance/?mode=total" id="id_create_cell" class="topopup">
                                <span style="padding:0px 10px;">&rarr; Total Attendance</span></a>
                                
                            </li>
                            
                            <li class="cls_mnu_content">
                            	<a href="/report/cellmeetingattendance/?mode=bychurch"  id="id_create_cell_leader"><span style="padding:0px 10px;">&rarr; Attendance by Church</span></a>
                            </li>
                            ...
                            <!---->
                             ...
                             <li class="id_mnu_header" style="background-color:#70819C; color:#FFF;">
                            	<span style="padding:0px 10px;">Cell Meeting Chat Report</span>
                            </li>
                            
                            <li class="cls_mnu_content">
                            	<a href="/report/cellmeeting/?mode=chatcomments" id="id_create_cell" >
                                <span style="padding:0px 10px;">&rarr; Cell Meeting Chat Comments</span></a>
                                
                            </li>
                            
                            <li class="cls_mnu_content">
                            	<a href="/report/cellmeeting/?mode=totalchatcomments"  id="id_create_cell_leader"><span style="padding:0px 10px;">&rarr; Total Chat Comments</span></a>
                            </li>
                            
                            <li class="cls_mnu_content">
                            	<a href="/report/cellmeeting/?mode=chatcommentsbycell"  id="id_cell_outline"><span style="padding:0px 10px;">&rarr; Chat Comment By Cell</span></a>
                             </li>
                            ...
                            <li class="id_mnu_header" style="background-color:#70819C; color:#FFF;">
                            	<span style="padding:0px 10px;">Streaming Report</span>
                            </li>
                            
                            <li class="cls_mnu_content">
                            	<a href="/report/churches/?mode=streaming" id="id_view_cell"><span style="padding:0px 10px;">&rarr; Churches that Streamed</span></a>
                            </li>
                            
                            
                            
                             <li class="cls_mnu_content">
                            	<a href="/report/churches/?mode=notstreaming" id="id_view_cell_leader"><span style="padding:0px 10px;">&rarr; Churches not Streaming</span></a>
                             </li>
                ...
                <div class="nine columns">
                    ...
                    <p style="line-height:1.8125em; text-align:justify; font-size:11.8px;">
                        ...
                        <span style="font-size:1.625em; font-weight:bolder;">Welcome to Our Report System</span>
                      <br>
						<br>
						...
						1. View church service and cell meeting attendance report.
                        <br>
                        <br>

                        2. View church service and cell meeting chat comments
                        <br>
                        <br>
                        3. View the total chat on a particular service; beit church service or cell meeting 
                        <br>
                        <br>
						4. View churches that are streaming services
                        <br>
                        <br>
						5. View and export total churches that have signed up for the virtual church portal.
                        <br>
                        <br>
						6. View and export total members that attended church service or cell meetings.
                        <br>
						<br>
                        More so, these reports can be represented in chart formats and be exported in csv for record keeping.
                        <br>
						<br>
