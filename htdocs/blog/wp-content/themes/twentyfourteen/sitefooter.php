			...
			<div class="container">
				<div class="row holder">
					<div class="col-lg-3 col-md-3">
							<div class="logo">
								<img src="<?=base_url()."/asset";?>/images/logo2.png" alt="">
							</div>
						</div>
					<!-- footer navigation -->
	...
	<script src="<?=base_url()."/asset";?>/js/jquery.min.1.10.1.js"></script>
	<script src="<?=base_url()."/asset";?>/js/bootstrap.min.js"></script>
	<script src="<?=base_url()."/asset";?>/js/jquery.essentials.js"></script>
	<script src="<?=base_url()."/asset";?>/js/jquery.mousewheel.js"></script>
	<script src="<?=base_url()."/asset";?>/js/jquery.countdown.js"></script>
	<script src="<?=base_url()."/asset";?>/js/jquery.owlcarousel.js"></script>
	<script src="<?=base_url()."/asset";?>/js/jquery.salvottore.js"></script>
	<script src="<?=base_url()."/asset";?>/js/jquery.scrolly.js"></script>
	<script src="<?=base_url()."/asset";?>/js/jquery.fancybox.js"></script>
	<script src="<?=base_url()."/asset";?>/js/jquery.fancybox-media.js"></script>
	<script src="<?=base_url()."/asset";?>/js/jquery.jplayer.js"></script>
	<script src="<?=base_url()."/asset";?>/js/jquery.ui.js"></script>
	<script src="<?=base_url()."/asset";?>/js/jquery.main.js"></script>
