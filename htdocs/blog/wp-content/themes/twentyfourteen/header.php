...
<head>
	...
	<link type="text/css" rel="stylesheet" href="/asset/css/all.css" media="all">
	<script src="https://oss.maxcdn.com/libs/html5shiv/3.7.0/html5shiv.js"></script>
	<script src="https://oss.maxcdn.com/libs/respond.js/1.4.2/respond.min.js"></script>
	<link media="all" rel="stylesheet" href="/asset/css/ie.css" />
    
    <link rel="shortcut icon" href="/asset/images/favicon.png"/>
    <link rel="stylesheet" href="/asset/css/bootstrap-datepicker.min.css" type="text/css" media="screen" charset="utf-8"/>
...
<body>
		...
		<header id="header">
			...
			<!--<div class="container has-feedback">
				<div class="row">
					...
					<!-- shoping cart
						<div class="shoping-cart" style="color: #3f3f3f;">
							<?php /*get_search_form(); */?>
						</div>
					</div>
				</div>
			...
			<div class="container has-feedback">
				<!-- logo -->
				<div class="logo">
					<a href="/"><img src="/asset/images/logo.png" alt="CE Online Church">
					</a>
				</div>
    ...
    <li>
        ...
        <ul class="dropdown-menu" role="menu">
            <li><a href="/churchmember/church_service">Live Services</a></li>
            <li><a href="/churchmember/videos">Service Highlights</a></li>
            <li><a href="/home/ministry_events">Ministry Events</a></li>
        </ul>
    </li>
    <li><a href="/foundation-school">Foundation School</a></li>
    <li><a href="/cellsystem/landing">Groups</a></li>
    <!--<li><a href="/home/online_giving">Online Giving</a></li>-->
    <li><a href="#">Resources</a>
        <ul class="dropdown-menu" role="menu">
            <li><a href="/blog/">Blog</a></li>

            <li><a href="/home/freebies/">Freebies</a></li>

        </ul>
    </li>

    <li><a href="/home/prayer">Prayer</a></li>
    <li><a href="/home/soul_diary">My Soul Diary</a></li>
