...
<footer id="colophon" class="site-footer" role="contentinfo">
	<?php do_action( 'itek_in_before_colophon' ); ?>
		...
		<div class="container">
			...
			<span class="sep"> | </span>
			<?php printf( __( 'BLW', '' ) ); ?><a target="_blank" href="<?php echo esc_url( __( 'http://www.wpstrapcode.com/blog/itek', '' ) ); ?>"><?php printf( __( ' ', '' ), 'iTek' ); ?></a><?php printf( __( ' aka %s', 'itek' ), 'ChristEmbassy Virtual Church!' ); ?>
